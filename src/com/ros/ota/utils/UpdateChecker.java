...
import com.ros.ota.UpdaterApplication;
import com.ros.ota.activities.UpdaterActivity;
import com.ros.ota.misc.Constants;
import com.ros.ota.misc.State;
import com.ros.ota.misc.UpdateInfo;
import com.ros.ota.requests.UpdatesJsonObjectRequest;
import com.ros.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.ros.ota.action.UPDATE_CHECK_FINISHED";
